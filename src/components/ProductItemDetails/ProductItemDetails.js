...
import SimilarProductItem from '../SimilarProductItem/SimilarProductItem';
...
function ProductItemDetails() {
    ...
    const getProductData = async (actualProductId) => {
        ...
        const apiUrl = `https://apis.ccbp.in/products/${actualProductId}`;
